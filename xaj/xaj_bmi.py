...
class xajBmi(Bmi):
    ...
    def initialize(self, config_file,params,p_and_e):
        try:
            ...
            self.q_sim_state,self.es_state,self.w0, self.w1,self.w2,self.s0, self.fr0, self.qi0, self.qg0 = configuration.warmup(p_and_e_warmup,params,config['warmup_length'],model_info)
